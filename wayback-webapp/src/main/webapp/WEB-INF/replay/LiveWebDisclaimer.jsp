...
<div id="wm-ipp-inside" style="position:fixed;padding:0!important;margin:0!important;width:97%;min-width:780px;border:5px solid #000;border-top:none;background-image:url(<%= staticPrefix %>images/toolbar/wm_tb_bk_trns.png);text-align:center;-moz-box-shadow:1px 1px 3px #333;-webkit-box-shadow:1px 1px 3px #333;box-shadow:1px 1px 3px #333;font-size:11px!important;font-family:'Lucida Grande','Arial',sans-serif!important;">
   ...
   <td style="padding:0!important;text-align:center;vertical-align:top;width:100%;">
       ...
       <td style="padding:3px 0;" colspan="2">
           <form target="_top" method="get" action="<%= queryPrefix %>query" name="wmtb" id="wmtb" style="margin:0!important;padding:0!important;"><input type="text" name="<%= WaybackRequest.REQUEST_URL %>" id="wmtbURL" value="<%= searchUrlSafe %>" style="width:400px;font-size:11px;font-family:'Lucida Grande','Arial',sans-serif;"/><input type="hidden" name="<%= WaybackRequest.REQUEST_TYPE %>" value="<%= WaybackRequest.REQUEST_REPLAY_QUERY %>"><input type="hidden" name="<%= WaybackRequest.REQUEST_DATE %>" value="<%= result.getCaptureTimestamp() %>"><input type="submit" value="<%= fmt.format("GraphTimeline.searchButtonText") %>" style="font-size:11px;font-family:'Lucida Grande','Arial',sans-serif;margin-left:5px;"/><span id="wm_tb_options" style="display:block;"></span></form>
       </td>
       </tr>
       <tr>
       <td style="padding:0!important;">
           <table style="border-collapse:collapse;margin:0;padding:0;width:100%;"><tbody><tr>
               <td rowspan="2" style="padding-right:10px!important;"><img src="<%= staticPrefix %>images/toolbar/icon_alert.png" width="24" height="24" border="0" alt="<%= fmt.format("Toolbar.alertIconAltTitle") %>"/></td>
               <td style="font-family:'Arial',sans-serif;font-size:14px;font-weight:700;color:#2eaeec; text-align:left;"><%= fmt.format("ReplayView.LiveWebNotCaptured") %></td>
           </tr>
           <tr>
               <td style="font-family:'Georgia',serif;font-size:13px;color:#333; text-align:left;"><%= fmt.format("ReplayView.LiveWebCapture", ageMins) %></td>
           </tr></tbody></table>
       </td>
       </tr></tbody></table>
   </td>
