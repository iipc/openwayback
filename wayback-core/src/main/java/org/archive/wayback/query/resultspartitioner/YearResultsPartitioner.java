/* YearResultsPartitioner
 *
 * $Id$
 *
 * Created on 4:40:57 PM Jan 11, 2006.
 *
 ...
 */
public class YearResultsPartitioner extends ResultsPartitioner {
	private static int MAX_SECONDS_SPANNED = 60 * 60 * 24 * 365 * 50;
