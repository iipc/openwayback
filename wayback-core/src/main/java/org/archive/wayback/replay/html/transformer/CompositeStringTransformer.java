...
/**
 * {@link StringTransformer} that aggregates multiple sub-
 * {@code StringTransformer}s that are applied in sequence. Formerly known as
 * {@code MultiRegexReplaceStringTransformer}.
 */
public class CompositeStringTransformer extends RewriteRule implements
		StringTransformer {
