...
public class TimestampTest extends TestCase {
	...
	public void testPadDateStr() {
		...
		assertEquals("padEnd","20061231235959",Timestamp.padEndDateStr("2"));
		assertEquals("padEnd","20061231235959",Timestamp.padEndDateStr("3"));
		...
		assertEquals("padEnd","20061231235959",Timestamp.padEndDateStr("2007"));
