...
public abstract class ResultURIConverter implements PropertyConfigurable {
	...
	protected String searchResultToAbsoluteUrl(SearchResult result) {
		...
		if (abs.startsWith(WaybackConstants.HTTP_URL_PREFIX))
			return abs;
	...
	/**
	 * @param result
	 * @return the URL prefix for the replay service, which when another URL is
	 *         appended, will drive back to the replay service
	 */
